...
__webpack_require__(/*! ./config/config */ "./resources/js/config/config.js");

__webpack_require__(/*! ./components/homepage */ "./resources/js/components/homepage.js");

__webpack_require__(/*! ./components/new_paint */ "./resources/js/components/new_paint.js");
...
$(document).on('click', '.mark-completed', function () {
  var id = $(this).data('id');
  homePageFunctions.updatePaintJob({
    'id': id
  });
});
...
homePageFunctions = {
   ...
   */
  updatePaintJob: function updatePaintJob() {
    var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    $.ajax({
      method: 'GET',
      // Type of response and matches what we said in the route
      url: $.job_paint_url + $.update_paint_jobs,
      ...
      error: function error(jqXHR, textStatus, errorThrown) {// What to do if we fail
      }
    });
  }
};
...
/***/ "./resources/js/components/new_paint.js":
/*!**********************************************!*\
  !*** ./resources/js/components/new_paint.js ***!
  \**********************************************/
/*! no static exports found */
...
newPaintJobFunctions = {
   ...
   * @return {[type]} [description]
   */
  changeColorCar: function changeColorCar() {
    var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'current';
   ...
   * @return {[type]} [description]
   */
  createPaintJob: function createPaintJob() {
    var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
    $('input[name="plate_number"]').removeClass('error');
    $.ajax({
      method: 'GET',
      // Type of response and matches what we said in the route
      url: $.job_paint_url + $.save_paint_jobs,
      // This is the url we gave in the route
      data: data,
      // a JSON object to send back
      success: function success(response) {
...
// controller routes
$.save_paint_jobs = 'createpaintjob';
$.update_paint_jobs = 'updatestatus';
...
__webpack_require__(/*! /var/www/html/exam/auto_paint/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /var/www/html/exam/auto_paint/resources/sass/app.scss */"./resources/sass/app.scss");
